...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Header */
    .header { display:flex; justify-content:space-between; align-items:flex-start; border-bottom:3px solid #D97706; padding-bottom:14px; margin-bottom:14px; }
    ...
    .nota-label .title { font-size:18px; font-weight:900; color:#D97706; }
    .nota-label .code { font-size:13px; font-weight:700; color:#1a1a1a; font-family:monospace; margin-top:4px; }

    /* Meta info */
    .meta-bar { display:grid; grid-template-columns:repeat(4,1fr); gap:10px; background:#FEF3C7; border:1px solid #D97706; border-radius:8px; padding:10px 14px; margin-bottom:14px; }
    ...
    .status-Design  { background:#FEF3C7; color:#92400E; border:1px solid #D97706; }
    .status-Cetak   { background:#FEF3C7; color:#92400E; border:1px solid #D97706; }
    .status-Selesai { background:#FEF3C7; color:#92400E; border:1px solid #D97706; }
    ...
    .items-table thead th {
      background:#1a1a1a; color:#D97706; padding:8px 10px;
    ...
    .grand-row { background:#1a1a1a; color:#D97706; padding:10px 12px; border-radius:6px; display:flex; justify-content:space-between; font-size:15px; font-weight:900; margin-top:6px; }

    /* Ringkasan ukuran untuk operator */
    .operator-box { background:#FEF3C7; border:1px solid #D97706; border-left:4px solid #D97706; border-radius:6px; padding:10px 14px; margin-bottom:14px; }
    .operator-box .title { font-weight:700; color:#92400E; font-size:12px; margin-bottom:6px; }
    .operator-row { font-size:12px; margin-bottom:4px; }
    .operator-size { background:#FEF3C7; border:1px solid #D97706; padding:1px 8px; border-radius:4px; font-weight:900; font-size:13px; }
    ...
    /* Print button */
    .print-btn { display:block; background:#D97706; color:#fff; text-align:center; padding:12px; border-radius:8px; font-weight:700; font-size:14px; text-decoration:none; margin-bottom:20px; cursor:pointer; border:none; width:100%; }
